...
- [ ] **Definir Stack Tecnológico:** Confirmar el uso de Python (Django + Flet/Kivy) y PostgreSQL.
- [x] **Diseñar Arquitectura de Sistema:** Crear diagrama de bloques (Frontend, API, Backend, DB).

## Fase 2: Diseño Técnico (Blueprint)

- [ ] **Diseñar Diagrama Entidad-Relación (DER):** Definir tablas, campos y relaciones de base de datos.
...
- [ ] **Desarrollar Lógica de Negocio:** Programar el algoritmo que calcula el saldo neto de deudas.
...
- [ ] **Estructura Base:** Configurar el proyecto en Flet o Kivy.
...
- [ ] **Despliegue de Backend:** Subir el servidor Django a un servicio en la nube (ej. Heroku, PythonAnywhere) o servidor local.
